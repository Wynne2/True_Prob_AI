...
class StealsModel(BaseStatModel):
    ...
    def project(
        ...
        # Opponent turnover tendency drives steal opportunities
        if defense:
            # Higher turnovers_forced means opponent is sloppy (more steal chances)
        ...
        projected = clamp(projected, 0.0, 5.0)
